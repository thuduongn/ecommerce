...
const Register = () => {
    ...
    return (
        <div className='min-w-screen min-h-screen bg-[#cdcae9] flex justify-center items-center'>
            <div className='w-[350px] text-[#ffffff] p-2 m-6'>
                <div className='bg-[#6f68d1] p-6 rounded-md'>
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className='flex items-center w-full gap-3 mb-4'>
                            <input className='w-4 h04 text-blue-600 overflow-hidden bg-gray-200 rounded border-gray-300 focus:ring-blue-500' type='checkbox' name='checkbox' id='checkbox'/>
                            <label htmlFor='checkbox'>I agree to privacy policy</label>
                        </div>

                        <button className="bg-slate-800 w-full hover:shadow-blue-300 hover:shadow-lg text-white rounded-md px-7 py-2 mb-4">Sign Up</button>
