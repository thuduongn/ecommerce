            ...
            <div className='px-2 md:px-7 py-5'>
                <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                    <div className='flex justify-between items-center p-5 bg-white rounded-md gap-3'>
                        ...
                        <div className='w-[40px] h-[47px] rounded-full bg-[#ffbd59] flex justify-center items-center text-xl'>
                    ...
                    <div className='flex justify-between items-center p-5 bg-white rounded-md gap-3'>
                        ...
                        <div className='w-[40px] h-[47px] rounded-full bg-[#8c52ff] flex justify-center items-center text-xl'>
                    ...
                    <div className='flex justify-between items-center p-5 bg-white rounded-md gap-3'>
                        ...
                        <div className='w-[40px] h-[47px] rounded-full bg-[#4ea84d] flex justify-center items-center text-xl'>
                    ...
                    <div className='flex justify-between items-center p-5 bg-white rounded-md gap-3'>
                        ...
                        <div className='w-[40px] h-[47px] rounded-full bg-[#0097b2] flex justify-center items-center text-xl'>
                    ...
                    <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
                        <div className='w-full bg-white p-4 rounded-md text-black'>
                            <div className='flex justify-between items-center'>
                                <h2 className='font-semibold text-lg text-[#4D4D4D] pb-3'>Recent Seller Message</h2>
                            ...
                            <div className='flex flex-col gap-2 pt-6 text-[#d0d2d6]'>
                                <ol className='relative border-1 border-slate-600 ml-4'>
                                    <li className='mb-3 ml-6'>
                                        <div className='flex absolute -left-5 shadow-lg justify-center items-center w-10 h-10 p-[6px] bg-[#4ea84d] rounded-full z-10'>
                ...
                <div className='w-full p-4 bg-white rounded-md mt-6'>
                    <div className='flex justify-between items-center'>
                        <h2 className='font-semibold text-lg text-[#4D4D4D] pb-3 '>Recent Orders</h2>
                    ...
                    <div className='relative overflow-x-auto'>
                        <table className='w-full text-sm text-left text-[#4D4D4D]'>
                            ...
                            <tr>
                                ...
                                <th scope='col' className='py-3 pl-8'>Payment Status</th>
                                <th scope='col' className='py-3 pl-8'>Order Status</th>
                            </tr>
                            </thead>
                            ...
                            <tbody>
                                {
                                    [1, 2, 3, 4, 5].map((d, i) => (
                                        <tr key={i}>
                                            ...
                                            <td className="py-3 pl-8 font-medium whitespace-nowrap">Pending</td>
                                            <td className="py-3 pl-8 font-medium whitespace-nowrap">Pending</td>
